...
const NavLinks = () => {
    return (
        <>
            ...
            <HashLink className="px-4 font-extrabold text-[#004AAD] hover:text-[#004AAD]" to="/#portfolio">
                Results
            </HashLink>
            <HashLink className="px-4 font-extrabold text-[#004AAD] hover:text-[#004AAD]" to="/contact#contact">
                Contact Us
            </HashLink>
